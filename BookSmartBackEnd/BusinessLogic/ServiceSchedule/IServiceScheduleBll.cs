...
namespace BookSmartBackEnd.BusinessLogic.Interfaces
{
    public interface IServiceScheduleBll
    {
        ...
        List<ServiceResponse> GetServicesBySchedule(Guid scheduleId, bool excludeUnavailable = false);
        ...
        List<ServiceResponse> GetServicesByScheduleOverride(Guid scheduleOverrideId, bool excludeUnavailable = false);
